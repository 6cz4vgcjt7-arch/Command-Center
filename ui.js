(function(){
  ...
  function leaf(){return `<svg class="leafMark" viewBox="0 0 64 64" aria-hidden="true"><path d="M23 49.5C27.8 36.7 37.6 25.4 50 18.5c.3 12.4-8.1 23.9-20.6 28.2-2.1.7-4.2 1.6-6.4 2.8Z" fill="none" stroke="currentColor" stroke-width="3.2" stroke-linecap="round" stroke-linejoin="round"/><path d="M23 49.5c7.2-10.1 15.1-18.8 25.3-29.1" fill="none" stroke="currentColor" stroke-width="3.2" stroke-linecap="round" stroke-linejoin="round"/></svg>`;}
  function cycle(segments=0,size=""){const filled=Math.max(0,Math.min(4,Number(segments)||0));const arcs=[
    "M34 8 A24 24 0 0 1 56 30",
    "M56 34 A24 24 0 0 1 34 56",
    "M30 56 A24 24 0 0 1 8 34",
    "M8 30 A24 24 0 0 1 30 8"
