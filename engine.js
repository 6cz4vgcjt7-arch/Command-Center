(function(){
  ...
  window.CCEngine={allAccounts,activeAccounts,completedAccounts,totalBalance,accountKind,isDebt,focusAccount,reviewOrder,progressPercent,progressStatus,focusBalanceTrend,promoIsActive,effectiveApr,daysUntil,weeklyReviewsUntil,soonestPromo,isSeasonComplete};
})();
